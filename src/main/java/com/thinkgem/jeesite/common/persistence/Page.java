...
public class Page<T> {
	...
	public String toString() {
		...
		if (pageNo == first) {// 如果是首页
			...
			sb.append("<li><a href=\"javascript:\" onclick=\""+funcName+"("+prev+","+pageSize+",'"+funcParam+"');\">&#171; prev</a></li>\n");//上一页
		}
		...
		sb.append("<li class=\"disabled controls\"><a href=\"javascript:\">current ");//当前
		...
		sb.append(funcName+"("+pageNo+",this.value,'"+funcParam+"');\" onclick=\"this.select();\"/> number, ");//条
		sb.append("total " + count + " number"+(message!=null?message:"")+"</a></li>\n");
