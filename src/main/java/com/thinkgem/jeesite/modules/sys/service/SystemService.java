...
import com.thinkgem.jeesite.modules.sys.exception.FreezeException;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	//add by frank.liu
	public User login(String email, String password) throws UnknowAccountException, AuthenException,PasswordResetException {
		User param = new User();
		param.setEmail(email);
		User user = userDao.getByEmail(param);
		if (user == null) {
		...
		if(delFlag.equals(User.DEL_FLAG_DELETE)){
			throw new UnknowAccountException();
		}
