...
public class TestData extends DataEntity<TestData> {
	...
	private String androidUpdateId;
	...
	public String getAndroidUpdateId()
	{
		return androidUpdateId;
	}

	public void setAndroidUpdateId(String androidUpdateId)
	{
		this.androidUpdateId = androidUpdateId;
	}
