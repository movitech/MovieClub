...
<head>
	...
	<link rel="stylesheet" href="${ctxStatic}/Swiper-3.1.2/dist/css/swiper.min.css">
</head>
<body>
...
<script type="text/javascript" src="${ctxStatic}/jwplayer/jwplayer.js"></script>
...
<script type="text/javascript" src="${ctxStatic}/Swiper-3.1.2/dist/js/swiper.jquery.min.js"></script>
