...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/contact/contact/">Contact列表</a></li>
		<li class="active"><a href="${ctx}/contact/contact/form?id=${contact.id}">Contact<shiro:hasPermission name="contact:contact:edit">${not empty contact.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="contact:contact:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="contact" action="${ctx}/contact/contact/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">obj_type：</label>
			<div class="controls">
		...
		<div class="form-actions">
			<shiro:hasPermission name="contact:contact:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
